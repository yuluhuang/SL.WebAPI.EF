...
app.controller('myCollectController', function ($scope, myCollectAPIService, loginAPIService, $http) {
    ...
    $scope.submitCollect = function (collect) {
        ...
        if (collect.collectId) {
            ...
            putCollection.$put({colletId: collectId }, {}, function (response) {
                console.info(response);

            });

            //myCollectAPIService.put({ colletId: collectId }, collection, function (responde) {
            //    console.info(response);
            //});
            //$http({
            //    method: 'PUT',
            ...
            //    },
            //    url: 'odata/Collections(' + collectId + ')/',
            //    params: {
            ...
            //    }
            //});
            myCollectAPIService.put({}, collect, function (responde) {
                console.info(response);
            });
        }
        //  } else {
