...
namespace SL.WebAPI.EF.Controllers
{
    ...
    */
    public class CollectionController : ODataController
    {
        ...
        // GET odata/Collection(5)/userTable
        [Queryable]
